...
project demonstrates the effective application of digital signal processing in modern healthcare technology. 
...
1. Accurate noise reduction through sequential filtering. 
2. Reliable R-wave detection within threshold-defined parameters.
3. Heart rate calculation consistent with the signal characteristics.
